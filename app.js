...
// Check userAgent to see if we are on Safari (but not Chrome, which includes "Safari" in its UA)
...
if (!isSafari) {
  ...
  console.log("Safari detected; offline persistence is disabled to ensure reliable sync.");
}
